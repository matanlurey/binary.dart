...
extension type const Uint32._(int _) implements int {
  ...
  ///
  /// This is equivalent to `Uint32.min as int`.
  static const minInt = 0;

  /// The maximum value that this type can represent, as a plain [int].
  ///
  /// This is equivalent to `Uint32.max as int`.
  static const maxInt = 4294967295;

  /// Always `0`.
  static const zero = Uint32.fromUnchecked(0);

  /// Always `1`.
  static const one = Uint32.fromUnchecked(1);

  /// The minimum value that this type can represent.
  static const min = Uint32.fromUnchecked(minInt);

  /// The maximum value that this type can represent.
  static const max = Uint32.fromUnchecked(maxInt);
  ...
  factory Uint32.checkRange(int value) {
  ...
  /// ```
  Uint32 nextPowerOf2() {
    return Uint32(_descriptor.overflowingNextPowerOf2(_));
  }
  ...
  ///
  /// If the result is out of range, the behavior is undefined.
  Uint32 uncheckedNextPowerOf2() {
    return Uint32.fromUnchecked(_descriptor.overflowingNextPowerOf2(_));
  }
  ...
  /// ```
  Uint32 wrappedNextPowerOf2() {
    return Uint32.fromWrapped(_descriptor.overflowingNextPowerOf2(_));
  }
  ...
  /// ```
  Uint32 clampedNextPowerOf2() {
    return Uint32.fromClamped(_descriptor.overflowingNextPowerOf2(_));
  }
  ...
  /// ```
  Uint32 nextMultipleOf(Uint32 n) {
    return Uint32(_descriptor.overflowingNextMultipleOf(_, n));
  }
  ...
  Uint32 uncheckedNextMultipleOf(Uint32 n) {
    return Uint32.fromUnchecked(_descriptor.overflowingNextMultipleOf(_, n));
  }
  ...
  /// ```
  Uint32? tryNextMultipleOf(Uint32 n) {
  ...
  Uint32 wrappedNextMultipleOf(Uint32 n) {
    return Uint32.fromWrapped(_descriptor.overflowingNextMultipleOf(_, n));
  }
  ...
  Uint32 clampedNextMultipleOf(Uint32 n) {
    return Uint32.fromClamped(_descriptor.overflowingNextMultipleOf(_, n));
  }
  ...
  Uint32 chunk(int left, [int? size]) {
  ...
  Uint32 uncheckedChunk(int left, [int? size]) {
  ...
  Uint32 slice(int left, [int? right]) {
    RangeError.checkValidRange(0, left, width - 1, 'left');
    if (right != null) {
  ...
  Uint32 uncheckedSlice(int left, [int? right]) {
  ...
  ///
  /// Both [left] and [right] must be in range.
  Uint32 replace(int left, int? right, int replacement) {
    RangeError.checkValidRange(0, left, width - 1, 'left');
    if (right != null) {
      RangeError.checkValidRange(left, right, width - 1, 'right');
    }
  ...
  ///
  /// If either [left] or [right] is out of range, the behavior is undefined.
  Uint32 uncheckedReplace(int left, int? right, int replacement) {
  ...
  ///
  /// For an unsigned integer, this is a no-op.
  @redeclare
  Uint32 operator -() => Uint32(-_);
