...
extension type const Int32._(int _) implements int {
  ...
  factory Int32.checkRange(int value) {
  ...
  /// ```
  Int32 nextPowerOf2() {
    return Int32(_descriptor.overflowingNextPowerOf2(_));
  }
  ...
  ///
  /// If the result is out of range, the behavior is undefined.
  Int32 uncheckedNextPowerOf2() {
    return Int32.fromUnchecked(_descriptor.overflowingNextPowerOf2(_));
  }
  ...
  /// ```
  Int32 wrappedNextPowerOf2() {
    return Int32.fromWrapped(_descriptor.overflowingNextPowerOf2(_));
  }
  ...
  /// ```
  Int32 clampedNextPowerOf2() {
    return Int32.fromClamped(_descriptor.overflowingNextPowerOf2(_));
  }
  ...
  /// ```
  Int32 nextMultipleOf(Int32 n) {
    return Int32(_descriptor.overflowingNextMultipleOf(_, n));
  }
  ...
  Int32 uncheckedNextMultipleOf(Int32 n) {
    return Int32.fromUnchecked(_descriptor.overflowingNextMultipleOf(_, n));
  }
  ...
  /// ```
  Int32? tryNextMultipleOf(Int32 n) {
  ...
  Int32 wrappedNextMultipleOf(Int32 n) {
    return Int32.fromWrapped(_descriptor.overflowingNextMultipleOf(_, n));
  }
  ...
  Int32 clampedNextMultipleOf(Int32 n) {
    return Int32.fromClamped(_descriptor.overflowingNextMultipleOf(_, n));
  }
  ...
  Int32 uncheckedChunk(int left, [int? size]) {
  ...
  Int32 slice(int left, [int? right]) {
    RangeError.checkValidRange(0, left, width - 1, 'left');
    if (right != null) {
  ...
  Int32 uncheckedSlice(int left, [int? right]) {
  ...
  ///
  /// Both [left] and [right] must be in range.
  Int32 replace(int left, int? right, int replacement) {
    RangeError.checkValidRange(0, left, width - 1, 'left');
    if (right != null) {
      RangeError.checkValidRange(left, right, width - 1, 'right');
    }
  ...
  ///
  /// If either [left] or [right] is out of range, the behavior is undefined.
  Int32 uncheckedReplace(int left, int? right, int replacement) {
  ...
  @redeclare
  Int32 operator <<(int shiftAmount) {
    return Int32(_descriptor.overflowingShiftLeft(_, shiftAmount));
  }
  ...
  /// ```
  Int32? tryShiftLeft(int shiftAmount) {
  ...
  Int32 wrappedShiftLeft(int shiftAmount) {
    return Int32.fromWrapped(_descriptor.overflowingShiftLeft(_, shiftAmount));
  }
  ...
  Int32 clampedShiftLeft(int shiftAmount) {
    return Int32.fromClamped(_descriptor.overflowingShiftLeft(_, shiftAmount));
  }
