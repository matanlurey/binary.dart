...
extension type const Int32._(int _) implements FixedInt {
  ...
  /// Defines an existing fixed-width integer [v] as a Int32.
  ///
  ...
  /// Int32.fromClamped(rawInt);
  /// ```
  @pragma('dart2js:tryInline')
  @pragma('vm:prefer-inline')
  factory Int32.fromInt(FixedInt v) => _descriptor.fitClamping(v.toInt());
