...
extension type const Uint16._(int _) implements int {
  ...
  /// Always `1`.
  static const one = Uint16.fromUnchecked(1);

  /// The minimum value that this type can represent.
  static const min = Uint16.fromUnchecked(minInt);

  /// The maximum value that this type can represent.
  static const max = Uint16.fromUnchecked(maxInt);
