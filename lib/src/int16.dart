...
extension type const Int16._(int _) implements int {
  ...
  ///
  /// This is equivalent to `Int16.min as int`.
  static const minInt = -32768;

  /// The maximum value that this type can represent, as a plain [int].
  ///
  /// This is equivalent to `Int16.max as int`.
  static const maxInt = 32767;
  ...
  static const min = Int16.fromUnchecked(minInt);

  /// The maximum value that this type can represent.
  static const max = Int16.fromUnchecked(maxInt);
